CREATE TABLE country (ID integer NOT NULL,NAME varchar(45) NOT NULL,AVAILABLE integer NOT NULL,PRIMARY KEY (ID));
CREATE TABLE favorites (ID integer NOT NULL,USER_ID integer,JOB_ID integer,PRIMARY KEY (ID));
...
CREATE TABLE province (	ID integer NOT NULL,NAME varchar(45) NOT NULL,COUNTRY_ID integer NOT NULL,PRIMARY KEY (ID));
CREATE TABLE town (	ID integer NOT NULL,NAME varchar(100) NOT NULL,	PROVINCE_ID integer NOT NULL,DC integer NOT NULL,COD_MUNUCIPIO integer NOT NULL,PRIMARY KEY (ID));
CREATE TABLE user (ID integer NOT NULL,"KEY" varchar(100),EMAIL varchar(150),MAIL_NOTIF_ACTIVE integer,DEVICE_NOTIF_ACTIVE integer,DEVICE_ID varchar(100),PRIMARY KEY (ID));
